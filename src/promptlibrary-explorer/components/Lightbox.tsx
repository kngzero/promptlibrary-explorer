  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row w-full h-full overflow-hidden">
        ...
        >
            ...
            <div className="w-full h-full flex items-center justify-center select-none">
              {isReferencePreviewActive && hasReferenceImages ? (
                <div className="w-full h-full relative">
                  <div className="absolute inset-0 bg-black/70 backdrop-blur-sm rounded-xl border border-fuchsia-500/30" />
                  <div className="relative w-full h-full p-4 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-fuchsia-600/80 text-xs font-semibold text-white">
          ...
          <button
            ...
            className={`absolute left-4 top-1/2 -translate-y-1/2 text-white bg-neutral-800/50 rounded-full p-2 hover:bg-neutral-700 transition-colors disabled:opacity-0 disabled:cursor-not-allowed ${isZoomed ? 'opacity-0 pointer-events-none' : 'opacity-0 group-hover:opacity-100 focus:opacity-100'
              }`}
          ...
          <button
            ...
            className={`absolute right-4 top-1/2 -translate-y-1/2 text-white bg-neutral-800/50 rounded-full p-2 hover:bg-neutral-700 transition-colors disabled:opacity-0 disabled:cursor-not-allowed ${isZoomed ? 'opacity-0 pointer-events-none' : 'opacity-0 group-hover:opacity-100 focus:opacity-100'
              }`}
          ...
          {images.length > 1 && (
            <div
              className={`absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 bg-neutral-900/80 backdrop-blur-sm rounded-xl p-2 max-w-full overflow-x-auto transition-opacity ${isZoomed ? 'opacity-0 pointer-events-none' : 'opacity-100'
                }`}
            >
      ...
      {imageContextMenu && contextMenuStyle && (
        ...
        >
          <div
            className="absolute bg-neutral-800 border border-neutral-700 rounded-md py-1 text-sm text-neutral-100 min-w-[180px]"
