        ...
        {isFolderOpen && (
          <>
            ...
            <div ref={sortRef} className="relative">
              ...
              {sortOpen && (
                <div className="absolute top-full right-0 mt-2 w-48 bg-zinc-800 border border-zinc-700 rounded-md z-30">
                  {sortOptions.map(opt => (
            ...
            <div ref={filterRef} className="relative">
              ...
              {filterOpen && (
                <div className="absolute top-full right-0 mt-2 w-48 bg-zinc-800 border border-zinc-700 rounded-md z-30 p-2 space-y-1">
