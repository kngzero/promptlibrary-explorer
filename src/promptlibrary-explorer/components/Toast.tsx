...
const Toast: React.FC<ToastProps> = ({ message, type, onClose }) => {
  ...
  return (
    <div
      className={`fixed top-5 left-1/2 -translate-x-1/2 z-[1200] pointer-events-none max-w-sm w-auto px-6 py-4 rounded-xl flex flex-col items-center text-center gap-3 text-white backdrop-blur-md ${BG_COLORS[type]} ${isExiting ? 'animate-slide-out-up' : 'animate-slide-in-down'}`}
      role="alert"
    >
